...
async function classifyImage() {
    ...
    image.onload = async function() {
        ...
        resultElement.innerHTML = `Tingkat Pengenalan Mesin: ${category}: ${topPrediction.className} (${(prediksi)}%)`;
        const resultElements = document.getElementById('result2');
        resultElements.innerHTML = `Tingkat Kerusakan: ${TingkatKerusakan} (${Tingkat}%)`;
...
async function saveResult() {
    ...
    const apiUrl = 'https://api.airtable.com/v0/appfCVfPcwccTepES/back';
    ...
    const data = {
        fields: {
            ...
            "AI": resultData.prediksi,
            "Damage Level": resultData.tingkat
        }
    };
...
function goToBackView() {
    window.location.href = 'backview.html';
}
function goToHomeView() {
    window.location.href = 'https://warshop.glide.page';
}
